...
--current date ile order_date değil de shipped date ile farkını almak gerek
...
--------------------------------------------------------
	  ...
	  -- where shipped_date is null hiç kargolanmamış olanlar
	  -- sipariş tarihi ile (order_date) kargolanma tarihi (shipped_date) arasında 35 gün olanları da katmalıyız
